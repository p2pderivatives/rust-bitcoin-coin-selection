...
fn main() {
    ...
    let bnb_selection = branch_and_bound(target, cost_of_change, fee_rate, long_term_fee_rate, &utxos);
    ...
    let coins_selection = select_coins(target, cost_of_change, fee_rate, long_term_fee_rate, &utxos);
